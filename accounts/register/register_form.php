...
<form method='post' action='/accounts/register_notice' id='register_form'> 
  ...
  <div id='sign_up'> 
	...
	<div><input type='checkbox' id='agree_term' name='term' value='term' checked='checked'/><label for='agree_term'>我已经认真阅读并同意口立方的《<a target='_blank' href='/terms'>使用协议</a>》</label><span id='term_tip'></span></div>
