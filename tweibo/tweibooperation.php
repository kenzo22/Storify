...
else
{
  ...
  foreach( $info as $item )
  {
    ...
    $weiboContent .= "<li class='weibo_drag tencent' id='".$item['id']."'><div class='handle'></div><div class='story_wrapper'><img class='profile_img' style='width: 32px; height: 32px; float:left; overflow: hidden; margin-top:3px;' 
