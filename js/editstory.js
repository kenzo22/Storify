...
$(function() {				
		...
		$('#my_tab').click(function()
		{
		  ...
		  if(sinaFlag)
		  {
			...
			{
			  var imply_txt = "<div class='bind_txt'><div class='imply_color'>查看我的微博需要绑定新浪微博帐号</div><a href='/accounts/source.php'>马上绑定</a></div>";
		  ...
		  else
		  {
			...
			{
			  var imply_txt = "<div class='bind_txt'><div class='imply_color'>查看我的广播需要绑定腾讯微博帐号</div><a href='/accounts/source.php'>马上绑定</a></div>";
			  $('#source_list').html(imply_txt);
			  return false;
			}
		  }
		...
		$('#follow_tab').click(function()
		{
		  ...
		  if(sinaFlag)
		  {
		    if($(this).hasClass('sina_disable'))
			{
			  var imply_txt = "<div class='bind_txt'><div class='imply_color'>查看我的关注需要绑定新浪微博帐号</div><a href='/accounts/source.php'>马上绑定</a></div>";
			  $('#source_list').html(imply_txt);
			  return false;
			}
		  }
		  else
		  {
		    if($(this).hasClass('tencent_disable'))
			{
			  var imply_txt = "<div class='bind_txt'><div class='imply_color'>查看我的收听需要绑定腾讯微博帐号</div><a href='/accounts/source.php'>马上绑定</a></div>";
			  $('#source_list').html(imply_txt);
			  return false;
			}
		  }
		...
		$('#pic_search_btn').click(function(e)
		{
		  ...
		  else if(1 == selected)
		  {
			...
			{
			  var imply_txt = "<div class='bind_txt'><div class='imply_color'>用户搜索功能需要绑定又拍帐号</div><a href='/accounts/source.php'>马上绑定</a></div>";
			  $('#source_list').html(imply_txt);
			  return false;
			}
