			...
			for(var sub in content_obj)
			{
			  ...
			  switch(sub_item.type)
			  {
				...
				case 'tweibo':
				  ...
				  break;
				case 'upload_img':
				  content +="<li class='img_upload_drop'><div class='img_wrapper'><img src='http://www.koulifang.com"+sub_item.img_src+"' /></div></li>";
				  break;
				case 'douban_event':
