...
<div class='inner'>
  <form id='fb_form' action="/processfeedback" method="post">
	...
	<div>您的姓名：</div>
	<span><input id='name_val' type="text" name="user_name" /></span>
	<div class='label'>您的邮箱:</div>
	<span><input id='email_val' type="text" name="email" /></span><span class='form_tip' id='email_tip'></span>
	<div class='label'>您的意见:</div>
	<textarea id='fb_val' name="feedback" cols="80" rows="10"></textarea>
	<div id='btn_submit_fb' class='label'>
