...
<form method='post' action='register_new.php' id='register_form'> 
  ...
  <div class='inner' id='sign_up'> 
	...
	<div id='btn_submit_signup' style='overflow:auto;'>
	  <input type='checkbox' id='agree_term' name='term' value='term'/><label for='agree_term'>同意并接受注册协议</label>
	  <a> 
        <span>完成注册</span>  
      </a> 
	  <span id='term_tip'></span>
    </div> 
...
$('#btn_submit_signup a span').click(function(e)
{
