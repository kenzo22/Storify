...
if(0 == $story_id)
{
  $DB->query("insert into ".$db_prefix."posts values
                         (null, '".$_SESSION['uid']."', '".$pulish_time."', '".$pulish_time."', '".$story_title."', '".$story_summary."', '".$story_content."', '".Draft."', '".$pulish_time."', '".$pulish_time."')");
...
{
  $result=$DB->query("update ".$db_prefix."posts set post_title='".$story_title."', post_summary='".$story_summary."', post_content='".$story_content."', post_status='Draft'  WHERE ID='".$post_id."'");
}
